...
@section('content')
    <div class="px-4 sm:px-6 lg:px-8">
        {!! Form::model($article, array('route' => array('articles.store', $article->id))) !!}
        <div>
            <div class="space-y-8 divide-y divide-gray-200 sm:space-y-5">
                <div class="pt-8 space-y-6 sm:pt-10 sm:space-y-5">
                    <div class="space-y-6 sm:space-y-5">
                        ...
                        <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                            {!! Form::label('description', 'Description', ['class' => 'block text-sm font-medium text-gray-700 sm:mt-px sm:pt-2']) !!}
                            <div class="mt-1 sm:mt-0 sm:col-span-2">
                        ...
                        <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                            ...
                            <div class="mt-1 sm:mt-0 sm:col-span-2">
                                {{ Form::select('department_id', $departments, ['class' => 'max-w-lg block focus:ring-indigo-500 focus:border-indigo-500 w-full shadow-sm sm:max-w-xs sm:text-sm border-gray-300 rounded-md']) }}
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="pt-5">
                <div class="flex justify-end">
                    <a href="{{ route('articles.index') }}" type="button" class="bg-white py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Cancel</a>
